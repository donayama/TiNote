...
[http://www.appcelerator.com/products/download/](http://www.appcelerator.com/products/download/)
...
**Titanium Downloads**というブロックがあるので、ご利用のプラットフォームに合わせてダウンロードをしてください。


![](images/TitaniumDownload.png)
...
> 
> すでにこういったエディタをお持ちの場合でない場合はTitanium MobileのAPI入力補完に対応した[Komodo Edit](http://www.activestate.com/komodo-edit)がおすすめです。
> Appceleratorの開発者の方はシェアウェアのTextMateを活用されています。
